...
import { Eye, EyeOff, Mail, Lock, GitlabIcon as GitHub, Facebook } from "lucide-react"
...
const Login = ({ onLogin }) => {
  ...
  const handleSocialLogin = async (provider) => {
    ...
    try {
      // Try to login with social provider
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-teal-900 to-teal-700 px-4 py-12">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-xl">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-3xl font-bold text-teal-800">Welcome back</h2>
          <p className="mt-2 text-sm text-gray-600">Sign in to continue to MindfulChat </p>
        </div>
